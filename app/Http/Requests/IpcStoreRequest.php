...
class IpcStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'monthly_variation' => 'required|numeric|min:0',
            'user_created' => 'required|string|max:255',
        ];
    ...
    public function messages()
    {
        return [
            ...
            'user_created.string' => 'El campo usuario creado debe ser una cadena de texto.'
        ];
    }
